...
if __name__ == "__main__":
    ...
    model.outcomes = [ScalarOutcome("CO2 TTW change trucks",
                      ...
                      ScalarOutcome(ScalarOutcome.MINIMIZE,"Driving cost light vehicles",
                                    variable_name="Resultat!F23"),
                      ScalarOutcome(ScalarOutcome.MINIMIZE,"Driving cost trucks",
    ...
    constraints = [Constraint("max CO2", outcome_names="CO2 TTW change total",
                   ...
                   Constraint("max bio", outcome_names="Energy bio total",
                                             function=lambda x : max(0, x-bio_target))]
...
#%%
    ...
    with MultiprocessingEvaluator(msis=model,n_processes=n_p) as evaluator:
        results, convergence = evaluator.optimize(nfe=2000, searchover='levers',
