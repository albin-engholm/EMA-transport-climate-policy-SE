# -*- coding: utf-8 -*-
"""
Created on Tue May 24 22:14:20 2022
...
This script is designed for analyzing a large set of sampled policies
@author: aengholm
"""
...
sns.scatterplot(y='CO2 TTW change total', x='Car el share', 
...
# sns.set_palette(sns.color_palette(colors_policy))
sns.displot(x='CO2 TTW change total', data=df_full, hue="ICE CO2 reduction ambition level",kde=True)
...
x_copy = x_copy.drop(columns=['model',"policy"])
