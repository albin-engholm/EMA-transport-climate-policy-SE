...
# %% specify simulation parameters
    ...
    nfe = 300000  # Number of nfes  in optimization
    from datetime import date
    date = date.today()
   # %% Specify inputs
    model.uncertainties = [
        RealParameter("X1_car_demand",
                      -0.3, 0.2, variable_name="C3"),
        RealParameter("X2_truck_demand", -0.3, 0.2,
                      variable_name="C4"), RealParameter("X3_fossil_fuel_price",
                                                         0.4, 1.3,
                                                         variable_name="C7"), RealParameter("X4_bio_fuel_price",
                                                                                            0.8, 2.2,
                                                                                            variable_name="C8"), RealParameter("X5_electricity_price",
                                                                                                                               .5, 1.5, variable_name="C9"), RealParameter("X6_car_electrification_rate",
                                                                                                                                                                           0.35, 0.9,
                                                                                                                                                                           variable_name="C5"), RealParameter("X7_truck_electrification_rate",
                                                                                                                                                                                                              .10, 0.60, variable_name="C6"), RealParameter("X8_SAV_market_share",
                                                                                                                                                                                                                                                            0, .45, variable_name="C15"), RealParameter("X9_SAV_driving_cost",
                                                                                                                                                                                                                                                                                                        -.1, 1,
                                                                                                                                                                                                                                                                                                        variable_name="Indata!G76"), RealParameter("X10_SAV_energy_efficiency",
                                                                                                                                                                                                                                                                                                                                                   0, 0.25,
                                                                                                                                                                                                                                                                                                                                                   variable_name="Indata!G75"), RealParameter("X11_VKT_per_SAV",
                                                                                                                                                                                                                                                                                                                                                                                              .5, 2, variable_name="C16"), RealParameter("X12_driverless_truck_market_share",
                                                                                                                                                                                                                                                                                                                                                                                                                                         0, 0.60, variable_name="C11"), RealParameter("X13_driverless_truck_driving_costs",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      -0.50, -0.20, variable_name="C14"), RealParameter("X14_driverless_truck_energy_efficiency",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        -0.2, -0.1, variable_name="C12"), RealParameter("X15_VKT_per_driverless_truck",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        0.2, 0.5, variable_name="C13")
    ]
    ...
    if External_electrification_rate == False:
        # Set external electrification parameter in excel to no
        model.constants = [Constant("C10", "No")]
...
# %%#Simulation settings and RUN
    ...
    for policy_type in policy_types:
        results_list = []
        convergence_list = []
        print("Estimated total runs: ", len(
